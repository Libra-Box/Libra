...
id. To specify a specific protocol, use the 'pb' option. The 'peer' and
'pb' options cannot be specified simultaneously. The protocols that are
...
`,
	...
	Run: func(req *cmds.Request, res cmds.ResponseEmitter, env cmds.Environment) error {
		...
		tstr, tfound := req.Options["pb"].(string)
		if pfound && tfound {
